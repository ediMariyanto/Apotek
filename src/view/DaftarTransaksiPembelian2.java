 ...
 */
public class DaftarTransaksiPembelian2 extends javax.swing.JInternalFrame {

    /**
     * Creates new form DaftarTransaksi
     */
    public DaftarTransaksiPembelian2() {
        initComponents();
        this.setTitle("Daftar Transaksi Pembelian");
        cariTransaksi("");
    ...
    private void cariTransaksi(String noNota) {
        ...
        setModelTransaksi(ct.getModelCariTransaksiBeli());
    }
        ...
        if (evt.getComponent() instanceof JTable) { //only right click -> (e.isPopupTrigger() && e.getComponent() instanceof JTable)
            ...
            previewItem.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    int rowindex = tblTransaksi.getSelectedRow();
                    TransaksiDetail td = new TransaksiDetail("beli", tblTransaksi.getValueAt(rowindex, 1).toString());
                }
            });
            ...
            deleteItem.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    if (JOptionPane.showConfirmDialog(null,
                            "Yakin ingin hapus Nota Nomor : " + nomorNota + " ?",
